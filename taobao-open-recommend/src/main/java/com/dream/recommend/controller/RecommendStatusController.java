...
@Controller
@RequestMapping("/recommendstatus")
public class RecommendStatusController extends BaseController<RecommendStatus,RecommendStatus,RecommendStatusCriteria>{
	...
	private final String LIST_ACTION = "redirect:/recommendstatus";
	 ...
	 */
	@RequestMapping
	public String index(ModelMap model,RecommendStatusQuery query,HttpServletRequest request,HttpServletResponse response) throws Exception {
		Page page = this.recommendStatusService.findPage(query);
		model.addAllAttributes(toModelMap(page, query));
		return "/recommendstatus/index";
	}
	...
	public String show(ModelMap model,@PathVariable java.lang.Long id) throws Exception {
		RecommendStatus key = null;
		RecommendStatus recommendStatus = (RecommendStatus)recommendStatusService.queryById(key);
		model.addAttribute("recommendStatus",recommendStatus);
		return "/recommendstatus/show";
	}
	...
	public String _new(ModelMap model,RecommendStatus recommendStatus,HttpServletRequest request,HttpServletResponse response) throws Exception {
		model.addAttribute("recommendStatus",recommendStatus);
		return "/recommendstatus/new";
	}
	...
	public String create(ModelMap model,@Valid RecommendStatus recommendStatus,BindingResult errors,HttpServletRequest request,HttpServletResponse response) throws Exception {
		if(errors.hasErrors()) {
			return  "/recommendstatus/new";
		}
	...
	public String delete(ModelMap model,@PathVariable java.lang.Long id) {
		RecommendStatus key = null;
		recommendStatusService.removeById(key);
...
//			recommendStatusService.removeById(items[i]);
		}
		Flash.current().success(DELETE_SUCCESS);
		return LIST_ACTION;
	}

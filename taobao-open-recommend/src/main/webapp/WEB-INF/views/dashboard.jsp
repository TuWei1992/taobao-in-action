...
<head>
    ...
    <script src="${ctx}/static/js/plugins/morris/raphael.min.js"></script>
    <script src="${ctx}/static/js/plugins/morris/morris.js"></script>
    <script src="${ctx}/static/js/plugins/morris/morris-data.js"></script>
</head>
<body>
			<div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">                        
                            <ul>
                                ...
                                <li>好评率：${store.shopScore.serviceScore} </li>
                                <li>卖家信用：0</li>
                                <li>全部宝贝：4  

...
public class XmlConstants {
    ...
    static {
        ...
        sb.append("countByCriteria"); //$NON-NLS-1$
        COUNT_BY_EXAMPLE_STATEMENT_ID = sb.toString();

        sb.setLength(0);
        sb.append(MergeConstants.NEW_XML_ELEMENT_PREFIX);
        sb.append("deleteByCriteria"); //$NON-NLS-1$
        ...
        sb.setLength(0);
        sb.append(MergeConstants.NEW_XML_ELEMENT_PREFIX);
        sb.append("selectByCriteria"); //$NON-NLS-1$
        SELECT_BY_EXAMPLE_STATEMENT_ID = sb.toString();

        sb.setLength(0);
        sb.append(MergeConstants.NEW_XML_ELEMENT_PREFIX);
        sb.append("selectByCriteriaWithBLOBs"); //$NON-NLS-1$
        ...
        sb.setLength(0);
        sb.append(MergeConstants.NEW_XML_ELEMENT_PREFIX);
        sb.append("updateByCriteria"); //$NON-NLS-1$
        UPDATE_BY_EXAMPLE_STATEMENT_ID = sb.toString();

        sb.setLength(0);
        sb.append(MergeConstants.NEW_XML_ELEMENT_PREFIX);
        sb.append("updateByCriteriaSelective"); //$NON-NLS-1$
        UPDATE_BY_EXAMPLE_SELECTIVE_STATEMENT_ID = sb.toString();

        sb.setLength(0);
        sb.append(MergeConstants.NEW_XML_ELEMENT_PREFIX);
        sb.append("updateByCriteriaWithBLOBs"); //$NON-NLS-1$
        ...
        sb.setLength(0);
        sb.append(MergeConstants.NEW_XML_ELEMENT_PREFIX);
        sb.append("Criteria_Where_Clause"); //$NON-NLS-1$

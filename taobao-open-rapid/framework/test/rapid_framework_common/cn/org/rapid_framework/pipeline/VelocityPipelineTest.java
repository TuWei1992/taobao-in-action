...
public class VelocityPipelineTest {
	...
	public void setUp() throws FileNotFoundException, Exception {
		...
		props.setProperty("userdirective","com.dream.rapid.velocity.directive.BlockDirective,com.dream.rapid.velocity.directive.OverrideDirective,com.dream.rapid.velocity.directive.ExtendsDirective");

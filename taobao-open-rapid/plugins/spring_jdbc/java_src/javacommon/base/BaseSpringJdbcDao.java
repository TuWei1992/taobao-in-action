...
import com.dream.rapid.xsqlbuilder.XsqlBuilder;
import com.dream.rapid.xsqlbuilder.XsqlBuilder.XsqlFilterResult;
import com.dream.rapid.xsqlbuilder.safesql.DirectReturnSafeSqlProcesser;
...
import com.dream.rapid.jdbc.sqlgenerator.CacheSqlGenerator;
import com.dream.rapid.jdbc.sqlgenerator.SpringNamedSqlGenerator;
import com.dream.rapid.jdbc.sqlgenerator.SqlGenerator;
import com.dream.rapid.jdbc.sqlgenerator.metadata.Column;
import com.dream.rapid.jdbc.sqlgenerator.metadata.MetadataCreateUtils;
import com.dream.rapid.jdbc.sqlgenerator.metadata.Table;
import com.dream.rapid.jdbc.support.OffsetLimitResultSetExtractor;
import com.dream.rapid.page.Page;
import com.dream.rapid.page.PageRequest;
import com.dream.rapid.util.CollectionHelper;
import com.dream.rapid.util.ObjectUtils;
import com.dream.rapid.util.SqlRemoveUtils;
/**
 * Spring的JDBC基类
 * @author Frank
 *
...
//		Map acceptedFilters = queryXsqlResult.getAcceptedFilters();
		...
		return pageQuery(sql, com.dream.rapid.beanutils.PropertyUtils.describe(pageRequest), totalCount, pageSize, pageNumber,rowMapper);
	}

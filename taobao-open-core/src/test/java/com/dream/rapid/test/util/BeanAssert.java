...
//    }
	...
	private static class Utils {
    	private static List<PropertyValue> getPropertyValues(Object bean,String... ignoreProperties) throws Error {
    		...
    		List<String> ignoreList = (List<String>) ((ignoreProperties != null) ? Arrays.asList(ignoreProperties) : Collections.emptyList());

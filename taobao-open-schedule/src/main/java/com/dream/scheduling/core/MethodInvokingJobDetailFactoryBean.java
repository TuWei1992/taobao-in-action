...
import com.dream.scheduling.core.MethodInvokingJobDetailFactoryBean;
...
public class MethodInvokingJobDetailFactoryBean implements FactoryBean, BeanNameAware, InitializingBean {
     ...
     * <p>
     * {@link #targetObject} or targetService must be set, but not both.
     * <p>
     */
     ...
     * <p>
     * {@link #targetService} or targetObject must be set, but not both.
     * <p>
	...
	public void afterPropertiesSet() throws Exception {
		try {
			...
			logger.info("Created JobDetail: " + jobDetail + "; targetClass: " + targetClass + "; targetService: " + targetService + "; targetObject: " + targetObject + "; targetMethod: "

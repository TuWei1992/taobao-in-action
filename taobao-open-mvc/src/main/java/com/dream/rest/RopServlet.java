 ...
 * 参数，则Rop就不会扫描Spring容器中的Bean了。如果既没有使用Servlet参数指定，也没有在Spring容器中配置，则Rop使用{@link DefaultSessionChecker}和{@link FileBaseAppSecretManager}
...
public class RopServlet extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3244943575570744336L;
    ...
    public void init(ServletConfig servletConfig) throws ServletException {
        ...
        if (this.serviceRouter == null) {
            logger.error("在Spring容器中未找到" + ServiceRouter.class.getName() +"的Bean,请在Spring配置文件中通过<rop:annotation-driven/>安装rop框架。");
        }
    }

...
/**
 * <pre>
 *      ROP的服务路由器，服务方法必须位于@Controller的类中，服务方法使用{@link com.dream.rest.annotation.ServiceMethod}注解，有两个合法的方法签名方式：
...
public interface ServiceRouter {
    ...
    /**
     * 设置{@link com.dream.rest.security.SecurityManager}
     *
     * @param securityManager
     */
    void setSecurityManager(com.dream.rest.security.SecurityManager securityManager);

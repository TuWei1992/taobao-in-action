 ...
 * @since 1.4
 */
public class AppCodeCheckBoxTag extends BasicSelectTagSupport {

	private static final long serialVersionUID = 3367760645555418777L;
	private final Log log = LogFactory.getLog(AppCodeCheckBoxTag.class);
...
//		}
		...
		if (scope != null) {
			...
			for (int i=0;i<appCodeList.size();i++) {
				...
				sb.append(">" + appCode.getCodeNameCn() + "\n");
			}
